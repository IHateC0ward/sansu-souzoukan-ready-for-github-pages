...
const courses = [
  { grade: "思考力養成コース", title: "算数的思考・創造力開発", tag: "FOUNDATION", text: "数や図形を“遊びながら発見する”体験を通して、公式に頼らず自分の言葉で考える土台を育てます。", points: ["パズル・図形感覚", "試行錯誤する習慣", "少人数対話型授業"] },
  { grade: "算数モデルコース", title: "コアモデル・解法構築", tag: "CORE", text: "文章題の構造を可視化し、未知の問題にも転用できる思考モデルと解法技術を体系的に習得します。", points: ["比・速さ・場合の数", "思考プロセスの言語化", "週間個別フィードバック"] },
  { grade: "難関校進学コース", title: "最難関校・最終問題突破", tag: "ADVANCED", text: "学校別の出題思想を読み解き、合否を分ける最終問題を時間内に攻略する実戦力を磨きます。", points: ["志望校別演習", "本番型タイムトライアル", "答案作成・部分点戦略"] },
  { grade: "探究チャレンジコース", title: "算数オリンピック・チャレンジ", tag: "OLYMPIAD", text: "既知の枠組みを越える最高峰の問題に挑み、ひらめきを論理へ昇華する選抜クラスです。", points: ["ジュニア算数オリンピック", "独創的アプローチ", "トップ層ゼミ形式"] }
];
...
export default function Home() {
  ...
  return <main>
    ...
    <section className="contact" id="contact">
      <Geometry/><div className="contact-copy"><div className="section-label"><span>05</span> TRIAL LESSON</div><h2>まずは、思考が<br/>変わる瞬間を。</h2><p>お子さまの現在地と可能性を、プロ講師が丁寧に見極めます。無理な勧誘は一切ありません。</p><div className="contact-note"><b>無料体験授業</b><span>授業 60分 ＋ 個別フィードバック 20分</span><span>电话：070-9087-9691</span><span>地址：名古屋市中区新荣1丁目30-29</span><span>时间：周一至周日 09:00-20:00</span><span>网址：up.deccmath.jp</span><span>邮箱：deccmath＠gmail.com</span></div></div>
