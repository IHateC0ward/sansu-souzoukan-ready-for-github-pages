...
export default function Home() {
  ...
  return <main>
    <header className="header">
      <a className="brand" href="#top"><span className="brand-mark">< img src="/logo.png" alt="logo" width={24} height={24} /></span><span><strong>算数創造館</strong><small>SANSU SOZOKAN</small></span></a>
